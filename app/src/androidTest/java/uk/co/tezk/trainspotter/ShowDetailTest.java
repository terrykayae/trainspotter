...
public class ShowDetailTest {
    ...
    public void showDetailTest() {
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.classListRecyclerview),
                        withParent(withId(R.id.mainContainer)),
                        isDisplayed()));
        recyclerView.perform(actionOnItemAtPosition(217, click()));

        ViewInteraction recyclerView2 = onView(
                allOf(withId(R.id.trainListRecyclerView),
                        withParent(withId(R.id.mainContainer)),
                        isDisplayed()));
        ...
        ViewInteraction gridLayout = onView(
                allOf(withId(R.id.gridLayout),
                        childAtPosition(
                                allOf(withId(R.id.cardViewDetails),
                                        childAtPosition(
