...
public class RealmTrainSpotterInteractorImpl implements TrainSpotterInteractor {
    private Realm realm;
...
//        realm = Realm.getDefaultInstance();
    ...
    public Observable<List<TrainListItem>> getTrains(String classNumber) {
        ...
        RealmResults<TrainListItem> results = realm.where(TrainListItem.class).equalTo("trainClass", classNumber).findAll();
        // Nothing in database, return empty observable
