...
public class CachedInteractor {
                ...
                .subscribe(new Observer<String>() {
                    ...
                    public void onCompleted() {
                        ...
                        if (cacheListener != null)
                            cacheListener.onApiCompleted();
                    }

                    @Override
                    public void onError(Throwable e) {
                        Log.e("CachedInteractor", "error " + e.getMessage());
                        realm = null;
                    }
                        ...
                        realm.executeTransaction(new Realm.Transaction() {
                            ...
                            public void execute(Realm realm) {
                                ...
                                if (realm.where(TrainListItem.class)
                                        .equalTo("trainClass", trainListItem.getClass_())
    ...
    public void attachListener(CacheListener cacheListener) {
